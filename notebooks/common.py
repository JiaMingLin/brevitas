...
from brevitas.quant.none import *
...
class SignedBinaryWeightConst(SignedBinaryWeightPerTensorConst):
    scaling_const = 0.125

class SignedTernaryWeightConst(SignedTernaryWeightPerTensorConst):
    scaling_const = 0.125
...
weight_quantizer = {
                    ...
                    'int2': SignedTernaryWeightConst,
                    'int1': SignedBinaryWeightConst,
                    'int0': NoneWeightQuant,
                    'fxp8': Int8WeightPerTensorFixedPointScratch,
                    'fxp4': Int4WeightPerTensorFixedPointScratch,
                    'fxp2': SignedTernaryWeightConst,
                    'fxp1': SignedBinaryWeightConst,
                    'fxp0': NoneWeightQuant}
...
act_quantizer = {
                ...
                'int1': SignedBinaryActPerTensorConst,
                'int0':  NoneActQuant,
                ...
                'fxp2': SignedTernaryActPerTensorConst,
                'fxp1': SignedBinaryActPerTensorConst,
                'fxp0': NoneActQuant,
